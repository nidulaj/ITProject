...
export default function ResetPasswordStaff() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("http://localhost:5000/api/staff/auth/reset-password", {
        token,
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                <span className="font-medium">Security tip:</span> Choose a
                strong password with a mix of letters, numbers, and symbols.
